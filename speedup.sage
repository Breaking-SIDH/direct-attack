...
https://github.com/jack4818/Castryck-Decru-SageMath/blob/main/speedup.sage

The purpose of this is to monkey patch slow performance of hyperelliptic
operations for SageMath versions 9.6 and below. Additionally we apply the
proof.all() to be false.
"""
